...
app.include_router(producto_categoria_router, prefix="/producto-categorias", tags=["producto-categorias"])
app.include_router(producto_ingrediente_router, prefix="/producto-ingredientes", tags=["producto-ingredientes"])
